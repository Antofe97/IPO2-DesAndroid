    ...
    public void crear(View view) {
        if (txtNombre.getText().length() == 0 || txtDesc.getText().length() == 0) {
            ...
            if (modificar.equals("modificar")) {
                ...
                conectorBD.abrir();
                conectorBD.modificarRecomendacion(recomendaciones.get(position).getNombre(), recomendaciones.get(position).getComentario(), recomendaciones.get(position).getLatitud(), recomendaciones.get(position).getLongitud(), recomendaciones.get(position).getImagenBit(), recomendaciones.get(position).getTipo());
                conectorBD.cerrar();
                ...
                conectorBD.abrir();
                conectorBD.insertarRecomendacion(nuevaRecomendacion.getNombre(), nuevaRecomendacion.getComentario(), nuevaRecomendacion.getLatitud(), nuevaRecomendacion.getLongitud(), nuevaRecomendacion.getImagenBit(),nuevaRecomendacion.getTipo());
                conectorBD.cerrar();
                recomendaciones.add(nuevaRecomendacion);
